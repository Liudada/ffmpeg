...
static const AVOption options[] = {
    ...
    { "ROIpath", "ROI path", OFFSET(qpDeltaMapFile), AV_OPT_TYPE_STRING, { 0 }, 0, 0, VE },
    { "QpEnh", "qp enhance", OFFSET(qpEnh), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, INT_MAX, VE },
    { "QpFade", "qp fade", OFFSET(qpFade), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, INT_MAX, VE },
    { NULL }
};
